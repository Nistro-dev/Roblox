    ...
    RunService.RenderStepped:Connect(function(dt)
        if isMoving and humanoid and root then
            ...
            if target and target:FindFirstChild("HumanoidRootPart") then
                ...
                -- Détection d'obstacle avec saut automatique
                ...
                if hit then
                    ...
                    if obstacleHeight > 1 and obstacleHeight < 4 then
                        print(("🟩 Petit obstacle détecté (%.1fm), saut !"):format(obstacleHeight))
                        humanoid:ChangeState(Enum.HumanoidStateType.Jumping)
                    elseif obstacleHeight >= 4 then
...
print("Auto Move V22 chargé! Saut automatique sur petits obstacles")
