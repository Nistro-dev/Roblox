            ...
            if target and target:FindFirstChild("HumanoidRootPart") then
                ...
                if hit then
                    ...
                    if isWall then
                        ...
                        -- Gestion mur : contournement latéral conséquent
                        local strafeDir = (root.CFrame.RightVector:Dot((hitPart.Position - root.Position).Unit) > 0)
                                        and root.CFrame.RightVector
                                        or -root.CFrame.RightVector
...
print("Auto Move V16 chargé! Détection intelligente mur vs obstacle")
